...
Do not add runtime observers, DOM tree walkers, polling, timers, or other dynamic JavaScript behavior to tweaks or source patches unless I explicitly approve it first. Prefer build-time rewrites or CSS.
