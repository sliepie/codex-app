...
const SIDEBAR_PROJECT_GROUP_OVERFLOW_ITEM_SELECTOR =
  `${SIDEBAR_ROOT_SELECTOR} [role='list']>[role='listitem'].py-1:has(>button.text-token-description-foreground)`;
const SIDEBAR_PROJECT_GROUP_OVERFLOW_ITEM_DECLARATIONS =
  "padding-left:calc(0.5rem + 1px)!important;";
const SIDEBAR_PROJECT_GROUP_OVERFLOW_BUTTON_SELECTOR =
  `${SIDEBAR_PROJECT_GROUP_OVERFLOW_ITEM_SELECTOR}>button.text-token-description-foreground`;
...
const SIDEBAR_FOOTER_STYLE_RULES = [
  ...
  cssRule(
    SIDEBAR_PROJECT_GROUP_OVERFLOW_ITEM_SELECTOR,
    SIDEBAR_PROJECT_GROUP_OVERFLOW_ITEM_DECLARATIONS,
  ),
  cssRule(
