...
const SIDEBAR_PROJECTS_HEADER_ARCHIVE_CONTROL_SELECTOR =
  '.group\\/projects-section-header :is([aria-label="Archive all chats"],[title="Archive all chats"])';
const SIDEBAR_PROJECTS_HEADER_THIRD_CONTROL_SELECTOR =
  '.group\\/projects-section-header [class~="group-hover/projects-section-header:opacity-100"]:has(+ [class~="group-hover/projects-section-header:opacity-100"] + [class~="group-hover/projects-section-header:opacity-100"])';
...
const SIDEBAR_HOVER_CONTROL_STYLE_RULES = [
  cssRule(
    [
      SIDEBAR_PROJECTS_HEADER_ARCHIVE_CONTROL_SELECTOR,
