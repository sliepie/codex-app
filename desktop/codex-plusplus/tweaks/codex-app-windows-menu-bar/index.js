...
const EMPTY_LOWER_APP_HEADER_HIDDEN_MENU_SELECTOR =
  `:root[${WINDOWS_MENU_BAR_HIDDEN_ATTRIBUTE}="true"] main.main-surface>${EMPTY_LOWER_APP_HEADER_SELECTOR}`;
const EMPTY_LOWER_APP_HEADER_MAIN_FRAME_SELECTOR =
  `:root[${WINDOWS_MENU_BAR_HIDDEN_ATTRIBUTE}="true"] main.main-surface:has(>${EMPTY_LOWER_APP_HEADER_SELECTOR}) .app-shell-main-content-frame`;
