...
const windowsPrimaryWindowIconOption =
  'icon:process.platform===`win32`?require("node:path").join(process.resourcesPath,`assets`,`windows`,`icon.ico`):void 0,';
const windowsPrimaryWindowIconAppliedPattern =
  /BrowserWindow\(\{icon:process\.platform===`win32`\?require\("node:path"\)\.join\(process\.resourcesPath,`assets`,`windows`,`icon\.ico`\):void 0,width:/;
