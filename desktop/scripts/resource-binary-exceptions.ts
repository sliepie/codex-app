...
export const windowsArm64ResourceBinaryExceptions: WindowsArm64ResourceBinaryException[] = [
  {
    ...
    id: "node-repl",
    label: "node_repl",
    metadataRelativePath: "resources/cua_node/bin/node_repl.json",
    packageRelativePath: "resources/cua_node/bin/node_repl.exe",
    ...
    vendoredRelativePath: "resources/cua_node/bin/node_repl.exe",
  },
  {
    expectedArchitecture: "arm64",
    expectedMachine: peMachine.arm64,
    ...
    packageRelativePathPattern: /^resources\/plugins\/openai-bundled\/plugins\/chrome\/extension-host\/windows\/arm64\/extension-host\.exe$/,
  ...
  },
  {
    ...
    packageRelativePathPattern: /^resources\/plugins\/openai-bundled\/plugins\/computer-use\/node_modules\/@oai\/sky\/bin\/windows\/codex-computer-use\.exe$/,
