...
## Windows x64 resource-binary exceptions

The Windows ARM64 package has a small explicit x64 resource-binary exception
list. Each exception must be listed in
