...
| Vendored Node REPL helper | `desktop/resources/cua_node/bin/node_repl.exe` from `OpenAI.Codex_26.831.2377.0_arm64__2p2nqsd0c76g0` |
| Vendored Chrome extension host helper | `desktop/resources/extension-host.exe` from `OpenAI.Codex_26.831.2377.0_arm64__2p2nqsd0c76g0` |
| Vendored Computer Use helper | `desktop/resources/codex-computer-use.exe` from `OpenAI.Codex_26.831.2377.0_arm64__2p2nqsd0c76g0`; explicit x64 exception |
...
| Store architecture check | Microsoft Store package `9PLM9XGG6VKS` installed `OpenAI.Codex_26.831.2377.0_arm64__2p2nqsd0c76g0`; Node REPL and Chrome extension-host are ARM64, while Computer Use remains x64 |
...
| Node REPL helper | Store package `OpenAI.Codex_26.831.2377.0_arm64__2p2nqsd0c76g0` | `resources/cua_node/bin/node_repl.exe` SHA-256 = `675a4d5574b49470096487e46aeb9968105449dd209392673f3ba50c90958e79` | Store-vendored ARM64 helper |
| Chrome extension host helper | Store package `OpenAI.Codex_26.831.2377.0_arm64__2p2nqsd0c76g0` | `resources/extension-host.exe` SHA-256 = `1ec19fd728cd1a39b723e37e8321ee21f6d07065d83b670a88f40597016e031f` | Store-vendored ARM64 helper |
| Computer Use helper | Store package `OpenAI.Codex_26.831.2377.0_arm64__2p2nqsd0c76g0` | `resources/codex-computer-use.exe` SHA-256 = `4e32ad51132168b301b5c144336fdcf30caa0327af6bc3c3085671ff44558c3f` | Explicit x64 exception |
...
| `resources/cua_node/bin/node_repl.exe` | `ARM64` | Vendored from `OpenAI.Codex_26.831.2377.0_arm64__2p2nqsd0c76g0`; SHA-256 `675a4d5574b49470096487e46aeb9968105449dd209392673f3ba50c90958e79` |
| `resources/plugins/openai-bundled/plugins/chrome/extension-host/windows/arm64/extension-host.exe` | `ARM64` | Vendored from `OpenAI.Codex_26.831.2377.0_arm64__2p2nqsd0c76g0`; copied to the ARM64 plugin lookup path because the bundled installer uses `os.arch()`; SHA-256 `1ec19fd728cd1a39b723e37e8321ee21f6d07065d83b670a88f40597016e031f` |
| `resources/plugins/openai-bundled/plugins/computer-use/node_modules/@oai/sky/bin/windows/codex-computer-use.exe` | `x64` | Vendored from `OpenAI.Codex_26.831.2377.0_arm64__2p2nqsd0c76g0`; SHA-256 `4e32ad51132168b301b5c144336fdcf30caa0327af6bc3c3085671ff44558c3f` |
